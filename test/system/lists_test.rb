...
class ListsTest < ApplicationSystemTestCase
  ...
  test "creating a List" do
    ...
    fill_in "Closed", with: @list.closed
    fill_in "Idnboard", with: @list.idnboard
    fill_in "Name", with: @list.name
    fill_in "Pos", with: @list.pos
    fill_in "Softlimit", with: @list.softlimit
    fill_in "Subscribed", with: @list.subscribed
